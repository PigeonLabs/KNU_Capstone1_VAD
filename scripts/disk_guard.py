...
def experiment_roots():
    ...
    for p in psutil.process_iter(['pid','create_time']):
        ...
        try:
            ...
            scripts={'scripts/run_suite.py','scripts/publish_stage.py','scripts/run_stage3.py','scripts/run_stage4.py','scripts/run_stage5.py','scripts/run_stage6.py','scripts/run_stage7.py','scripts/run_stage8.py','scripts/run_stage9_1.py','scripts/stage9_quant_compile.py'}
