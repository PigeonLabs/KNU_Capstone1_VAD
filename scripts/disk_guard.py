...
def experiment_roots():
    ...
    for p in psutil.process_iter(['pid','create_time']):
        ...
        try:
            ...
            args=p.cmdline()
            modules={'ipad.train','ipad.features','ipad.prototype','ipad.evaluate','ipad.phase_routing','ipad.phase_temporal','ipad.stage4','ipad.stage5','ipad.stage6','ipad.stage7','ipad.stage7_alerts','ipad.stage7_stream'}
            scripts={'scripts/run_suite.py','scripts/publish_stage.py','scripts/run_stage3.py','scripts/run_stage4.py','scripts/run_stage5.py','scripts/run_stage6.py','scripts/run_stage7.py'}
