...
def snapshot(stage):
    ...
    if stage=='stage1':
        ...
        for name in ['status.json','runner.log','verification.txt','targeted_verification.txt','precision_diagnostic.json','gpu_before_benchmark.txt','implementation_events.jsonl']:
